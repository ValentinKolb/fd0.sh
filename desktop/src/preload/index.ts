...
const api: DesktopAPI = {
  ...
  removeScopeMember: (scopeId: string, memberId: string, label: string) => invoke("fd0:scope-remove-member", scopeId, memberId, label),
  ...
  openExternal: (url: string) => invoke("fd0:open-external", url),
